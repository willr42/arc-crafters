...
export const items: Record<string, Item> = {
  ...
  advanced_electrical_components: {
    ...
    description:
      'Used to craft a wide range of items. Can be recycled into crafting materials. Used to craft: Tactical Mk. 3 (Defensive), Combat Mk. 3 (Flanking), Combat Mk. 3 (Aggressive), Looting Mk. 3 (Cautious), Tactical Mk. 3 (Healing)',
    rarity: 'Rare',
    value: 1750,
    weightKg: 1,
    stackSize: 5,
  ...
  advanced_mechanical_components: {
    ...
    description:
      'Used to craft advanced weapons. Can be recycled into crafting materials. Used to craft: Torrente, Venator, Osprey, Renegade, Bettina',
    rarity: 'Rare',
    value: 1750,
    weightKg: 1,
    stackSize: 5,
    imageFilename:
      'https://cdn.arctracker.io/items/advanced_mechanical_components.png',
    recipe: {
      steel_spring: 2,
  ...
  angled_grip_i: {
    ...
    name: 'Angled Grip I',
    description:
      'Slightly reduces horizontal recoil. Compatible with: Tempest, Arpeggio, Kettle, Ferro, Hullcracker',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  angled_grip_ii: {
    ...
    name: 'Angled Grip II',
    description:
      'Moderately reduces horizontal recoil. Compatible with: Arpeggio, Ferro, Il Toro, Stitcher',
    rarity: 'Uncommon',
    value: 2000,
    weightKg: 0.5,
    ...
    compatibleWith: ['Arpeggio', 'Rattler', 'Kettle', 'Il Toro', 'Stitcher'],
    recyclesInto: {
      mechanical_components: 1,
      duct_tape: 1,
    },
  ...
  angled_grip_iii: {
    ...
    description:
      'Significantly reduces horizontal recoil. Compatible with: Arpeggio, Ferro, Venator, Il Toro, Stitcher',
    rarity: 'Rare',
    value: 5000,
    weightKg: 0.75,
  ...
  antiseptic: {
    ...
    name: 'Antiseptic',
    description:
      'Used to craft medical supplies. Can be recycled into chemicals. Used to craft: Sterilized Bandage, Vita Spray, Vita Shot',
    rarity: 'Rare',
    value: 1000,
    weightKg: 1,
    stackSize: 5,
  ...
  anvil_i: {
    ...
    name: 'Anvil I',
    description:
      'Single-action hand cannon with high damage and headshot damage, but slow handling.',
    rarity: 'Uncommon',
    value: 5000,
    weightKg: 5,
  ...
  combat_mk2: {
    ...
    name: 'Combat Mk. 2',
    description:
      'A Combat augment more focused on maneuverability than absorbing damage.',
    rarity: 'Rare',
    value: 2000,
    weightKg: 3,
    imageFilename: 'https://cdn.arctracker.io/items/combat_i.png',
  ...
  compensator_i: {
    ...
    name: 'Compensator I',
    description:
      'Slightly reduces per-shot dispersion. Compatible with: Arpeggio, Ferro, Renegade, Anvil, Stitcher',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  compensator_ii: {
    ...
    name: 'Compensator II',
    description:
      'Moderately reduces per-shot dispersion. Compatible with: Arpeggio, Ferro, Renegade, Anvil, Stitcher',
    rarity: 'Uncommon',
    value: 2000,
    weightKg: 0.5,
    ...
    compatibleWith: ['Arpeggio', 'Rattler', 'Kettle', 'Burletta', 'Stitcher'],
    recyclesInto: {
      mechanical_components: 1,
      wires: 1,
    },
  ...
  crude_explosives: {
    ...
    description:
      "Used to craft explosives. Can be recycled into crafting materials. Used to craft: Launcher Ammo, Explosive Compound, Snap Blast Grenade, Shrapnel Grenade, Trigger 'Nade",
    rarity: 'Uncommon',
    value: 270,
    weightKg: 0.5,
    stackSize: 10,
  ...
  durable_cloth: {
    ...
    name: 'Durable Cloth',
    description:
      'Used to craft medical supplies. Used to craft: Herbal Bandage, Sterilized Bandage',
    rarity: 'Uncommon',
    value: 640,
    weightKg: 0.25,
    stackSize: 10,
  ...
  electrical_components: {
    ...
    description:
      'Used to craft a wide range of items. Can be recycled into crafting materials. Used to craft: Tactical Mk. 2, Combat Mk. 2, Looting Mk. 2, Surge Shield Recharger, Lure Grenade',
    rarity: 'Uncommon',
    value: 640,
    weightKg: 0.5,
    stackSize: 10,
  ...
  energy_clip: {
    ...
    type: 'Ammunition',
    compatibleWith: ['Equalizer', 'Jupiter'],
  },
  equalizer: {
    id: 'equalizer',
    name: 'Equalizer',
  ...
  explosive_compound: {
    ...
    description:
      'Used to craft explosives. Used to craft: Wolfpack, Explosive Mine, Blaze Grenade, Heavy Fuze Grenade',
    rarity: 'Rare',
    value: 1000,
    weightKg: 0.3,
    stackSize: 5,
  ...
  extended_barrel: {
    ...
    description:
      'Moderately increases bullet velocity. Compatible with: Tempest, Arpeggio, Ferro, Renegade, Anvil',
    rarity: 'Epic',
    value: 5000,
    weightKg: 0.5,
  ...
  extended_light_mag_i: {
    ...
    description:
      'Slightly extends the ammo capacity of compatible weapons that use light ammo. Compatible with: Kettle, Burletta, Hairpin, Bobcat, Stitcher',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  extended_light_mag_ii: {
    ...
    description:
      'Moderately extends the ammo capacity of compatible weapons that use light ammo. Compatible with: Stitcher, Kettle, Burletta, Hairpin, Bobcat',
    rarity: 'Uncommon',
    value: 2000,
    weightKg: 0.5,
  ...
  extended_light_mag_iii: {
    ...
    description:
      'Significantly extends the ammo capacity of compatible weapons that use light ammo.',
    rarity: 'Rare',
    value: 5000,
    weightKg: 0.75,
  ...
  extended_medium_mag_i: {
    ...
    description:
      'Moderately extends the ammo capacity of compatible weapons that use medium ammo. Compatible with: Arpeggio, Renegade, Venator, Tempest, Torrente',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  extended_medium_mag_iii: {
    ...
    description:
      'Significantly extends the ammo capacity of compatible weapons that use medium ammo. Compatible with: Arpeggio, Renegade, Venator, Tempest, Torrente',
    rarity: 'Rare',
    value: 5000,
    weightKg: 0.75,
    imageFilename:
      'https://cdn.arctracker.io/items/extended_medium_mag_iii.png',
    type: 'Modification',
    recipe: {
      mod_components: 2,
      steel_spring: 5,
  ...
  extended_shotgun_mag_i: {
    ...
    description:
      'Slightly extends the ammo capacity of shotguns. Compatible with: Il Toro, Vulcano',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  extended_shotgun_mag_ii: {
    ...
    description:
      'Moderately extends the ammo capacity of shotguns. Compatible with: Il Toro, Vulcano',
    rarity: 'Uncommon',
    value: 2000,
    weightKg: 0.5,
    imageFilename:
      'https://cdn.arctracker.io/items/extended_shotgun_mag_ii.png',
    type: 'Modification',
    effects: {
      'Magazine Size': 'Magazine Size',
    },
  ...
  extended_shotgun_mag_iii: {
    ...
    description:
      'Significantly extends the ammo capacity of shotguns. Compatible with: Il Toro, Vulcano',
    rarity: 'Rare',
    value: 5000,
    weightKg: 0.75,
    imageFilename:
      'https://cdn.arctracker.io/items/extended_shotgun_mag_iii.png',
    type: 'Modification',
    effects: {
      'Magazine Size': 'Magazine Size',
    },
  ...
  free_loadout_augment: {
    ...
    description:
      'Basic augment for rookie Raiders, offering slightly more backpack space and carry capacity.',
    rarity: 'Common',
    value: 100,
    weightKg: 1,
  ...
  fruit_mix: {
    ...
    name: 'Fruit Mix',
    description:
      'A food item that moderately increases both health and stamina.',
    rarity: 'Uncommon',
    value: 1800,
    weightKg: 0.3,
    stackSize: 5,
  ...
  hairpin_i: {
    ...
    name: 'Hairpin I',
    description:
      'Has a built-in silencer. Great for stealth, but tricky in combat.',
    rarity: 'Common',
    value: 450,
    weightKg: 3,
  ...
  jupiter: {
    ...
    name: 'Jupiter',
    description:
      'A bolt-action sniper rifle with exceptional damage output and accuracy, but slow handling.',
    rarity: 'Legendary',
    value: 27500,
    weightKg: 9,
  ...
  kettle_i: {
    ...
    name: 'Kettle I',
    description:
      'Quick and accurate, but has low bullet velocity and takes a long time to reload.',
    rarity: 'Common',
    value: 840,
    weightKg: 7,
  ...
  kinetic_converter: {
    ...
    description:
      'Moderately increases fire rate. Compatible with: Arpeggio, Rattler, Kettle, Ferro, Renegade',
    rarity: 'Legendary',
    value: 7000,
    weightKg: 0.75,
  ...
  launcher_ammo: {
    ...
    name: 'Launcher Ammo',
    description:
      'Anti-ARC payloads used mainly by the Hullcracker. Compatible with: Hullcracker',
    rarity: 'Rare',
    value: 250,
    weightKg: 0.1,
    stackSize: 24,
    ...
    type: 'Ammunition',
    compatibleWith: ['Hullcracker'],
  },
  li_l_smoke_grenade: {
    id: 'li_l_smoke_grenade',
    name: "Li'l Smoke Grenade",
    description:
      'A grenade that pops a thick but small smoke cloud on impact, blocking visibility from ARC and other Raiders.',
    rarity: 'Common',
    value: 1,
    weightKg: 0.15,
    stackSize: 5,
  ...
  light_ammo: {
    ...
    name: 'Light Ammo',
    description:
      'Light bullets used mainly with SMGs and light handguns. Compatible with: Burletta, Stitcher, Kettle, Hairpin, Bobcat',
    rarity: 'Common',
    value: 0.76,
    weightKg: 0.00323,
    stackSize: 100,
    ...
    type: 'Ammunition',
    compatibleWith: ['Kettle', 'Burletta', 'Hairpin', 'Bobcat', 'Stitcher'],
  },
  ...
  light_shield: {
    ...
    name: 'Light Shield',
    description:
      'A lightweight shield that blocks a small portion of incoming damage without impacting mobility.',
    rarity: 'Uncommon',
    value: 640,
    weightKg: 5,
  ...
  lightweight_stock: {
    ...
    description:
      'Moderately improves ADS & draw speed. Compatible with: Arpeggio, Kettle, Ferro, Renegade, Hullcracker',
    rarity: 'Epic',
    value: 5000,
    weightKg: 0.25,
  ...
  lure_grenade: {
    ...
    name: 'Lure Grenade',
    description:
      'A noise device that sticks to surfaces, distracting nearby ARC machines and drawing their fire.',
    rarity: 'Uncommon',
    value: 1000,
    weightKg: 0.4,
  ...
  magnetic_accelerator: {
    ...
    description:
      'Used to craft advanced weapons. Used to craft: Tempest, Equalizer, Vulcano, Jupiter, Hullcracker',
    rarity: 'Epic',
    value: 5500,
    weightKg: 1,
    stackSize: 3,
  ...
  mechanical_components: {
    ...
    description:
      'Used to craft a wide range of items. Can be recycled into crafting materials. Used to craft: Il Toro, Burletta, Anvil, Muzzle Brake II, Extended Medium Mag II',
    rarity: 'Uncommon',
    value: 640,
    weightKg: 0.5,
    stackSize: 10,
  ...
  medium_ammo: {
    ...
    name: 'Medium Ammo',
    description:
      'Compatible with: Rattler, Tempest, Arpeggio, Renegade, Torrente',
    rarity: 'Common',
    value: 6,
    weightKg: 0.025,
    stackSize: 80,
    ...
    type: 'Ammunition',
    compatibleWith: ['Arpeggio', 'Rattler', 'Tempest', 'Renegade', 'Torrente'],
  },
  medium_shield: {
    id: 'medium_shield',
    name: 'Medium Shield',
  ...
  mod_components: {
    ...
    name: 'Mod Components',
    description:
      'Used to craft weapon mods. Can be recycled into crafting materials. Used to craft: Lightweight Stock, Shotgun Choke III, Extended Shotgun Mag III, Padded Stock, Compensator III',
    rarity: 'Rare',
    value: 1750,
    weightKg: 1,
    stackSize: 5,
  ...
  muzzle_brake_i: {
    ...
    name: 'Muzzle Brake I',
    description:
      'Slightly reduces both vertical recoil & horizontal recoil. Compatible with: Rattler, Ferro, Burletta, Stitcher, Tempest',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  muzzle_brake_ii: {
    ...
    description:
      'Moderately reduces both vertical recoil & horizontal recoil. Compatible with: Tempest, Arpeggio, Kettle, Ferro, Renegade',
    rarity: 'Uncommon',
    value: 2000,
    weightKg: 0.5,
  ...
  muzzle_brake_iii: {
    ...
    description:
      'Significantly reduces both vertical recoil & horizontal recoil. Compatible with: Arpeggio, Ferro, Renegade, Anvil, Stitcher',
    rarity: 'Rare',
    value: 5000,
    weightKg: 0.75,
  ...
  padded_stock: {
    ...
    name: 'Padded Stock',
    description:
      'Significantly improves stability. Compatible with: Arpeggio, Rattler, Ferro, Renegade, Torrente',
    rarity: 'Epic',
    value: 5000,
    weightKg: 0.5,
  ...
  photoelectric_cloak: {
    ...
    description:
      'A gadget that allows the user to conceal themselves from ARC.',
    rarity: 'Epic',
    value: 5000,
    weightKg: 1,
  ...
  shotgun_choke_i: {
    ...
    description:
      'Slightly reduces base dispersion. Compatible with: Il Toro, Vulcano',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  shotgun_choke_ii: {
    ...
    description:
      'Moderately reduces base dispersion. Compatible with: Il Toro, Vulcano',
    rarity: 'Uncommon',
    value: 2000,
    weightKg: 0.5,
  ...
  silencer_ii: {
    ...
    name: 'Silencer II',
    description:
      'Moderately reduces the amount of noise produced when firing. Compatible with: Arpeggio, Ferro, Renegade, Anvil, Stitcher',
    rarity: 'Rare',
    value: 5000,
    weightKg: 0.5,
  ...
  silencer_iii: {
    ...
    name: 'Silencer III',
    description:
      'Significantly reduces the amount of noise produced when firing. Compatible with: Tempest, Arpeggio, Kettle, Ferro, Renegade',
    rarity: 'Epic',
    value: 7000,
    weightKg: 0.75,
    ...
    compatibleWith: ['Arpeggio', 'Rattler', 'Ferro', 'Anvil', 'Torrente'],
    recyclesInto: {
      mod_components: 1,
      wires: 3,
    },
  ...
  snap_hook: {
    ...
    name: 'Snap Hook',
    description:
      'A gadget that allows the user to scale structures and cover large distances.',
    rarity: 'Legendary',
    value: 14000,
    weightKg: 5,
  ...
  stable_stock_i: {
    ...
    compatibleWith: ['Rattler', 'Ferro', 'Stitcher', 'Arpeggio', 'Bettina'],
    recyclesInto: {
      rubber_parts: 6,
    },
    salvagesInto: {
  ...
  sterilized_bandage: {
    ...
    description:
      'A medical item that gradually restores a large amount of health over time.',
    rarity: 'Rare',
    value: 2000,
    weightKg: 0.2,
    stackSize: 3,
  ...
  stitcher_i: {
    ...
    name: 'Stitcher I',
    description:
      'Deals good damage, but has quite a low fire-rate and can be hard to control.',
    rarity: 'Common',
    value: 800,
    weightKg: 5,
  ...
  torrente_i: {
    ...
    name: 'Torrente I',
    description:
      'Has a large ammo capacity, but is only accurate while crouched',
    rarity: 'Rare',
    value: 7000,
    weightKg: 12,
  ...
  vertical_grip_i: {
    ...
    description:
      'Slightly reduces vertical recoil. Compatible with: Tempest, Arpeggio, Kettle, Ferro, Hullcracker',
    rarity: 'Common',
    value: 640,
    weightKg: 0.25,
  ...
  vertical_grip_ii: {
    ...
    description:
      'Moderately reduces vertical recoil. Compatible with: Arpeggio, Ferro, Venator, Il Toro, Stitcher',
    rarity: 'Uncommon',
    value: 2000,
    weightKg: 0.5,
  ...
  vertical_grip_iii: {
    ...
    description:
      'Significantly reduces vertical recoil. Compatible with: Tempest, Kettle, Hullcracker, Venator, Il Toro',
    rarity: 'Rare',
    value: 5000,
    weightKg: 0.75,
  ...
  vita_spray: {
    ...
    name: 'Vita Spray',
    description:
      'A medical item that continuously restores health during use. Can be used on yourself or your allies.',
    rarity: 'Epic',
    value: 3000,
    weightKg: 1,
    stackSize: 1,
